...
export function NewThread({ children }: React.PropsWithChildren) {
        ...
        const newComment = (e: MouseEvent) => {
            ...
            if (creatingCommentState === "placed") {
                const isClickOnComposer = ((
                    e as MouseEvent & Record<string, boolean>
                )._savedComposedPath = e.composedPath().some((el) => {
    ...
    useEffect(() => {
        const handlePointerMove = (e: PointerEvent) => {
            (
                e as PointerEvent & Record<string, EventTarget[]>
            )._savedComposedPath = e.composedPath();
